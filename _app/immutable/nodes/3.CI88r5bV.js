import"../chunks/DsnmJJEf.js";import"../chunks/DaZO00A4.js";import{at as x,f as c,t as f,a as r,au as P,s as m,c as n,r as i,a3 as T,g as h,n as R}from"../chunks/BAyQ-u7M.js";import{s as C}from"../chunks/Db2s9hl6.js";import{s as I}from"../chunks/Ke4v9qem.js";import{e as _,i as k}from"../chunks/DFBHM9IF.js";import{s as u}from"../chunks/CSzx4h4e.js";var A=c('<a><img class="w-8"/></a>'),S=c('<div class="flex flex-col font-mono gap-4"><span class="text-xl md:text-2xl xl:text-3xl font-semibold"> </span> <div class="w-fit flex"></div> <div class="text-justify flex-shrink-0 md:text-lg lg:text-xl xl:text-2xl"><!></div></div>');function y(d,e){x(e,!0);var t=S(),s=n(t),l=n(s,!0);i(s);var o=m(s,2);_(o,21,()=>e.links,k,(w,g)=>{var p=A(),v=n(p);i(p),f(()=>{u(p,"href",h(g).url),u(v,"src",h(g).icon),u(v,"alt",h(g).alt)}),r(w,p)}),i(o);var a=m(o,2),b=n(a);I(b,()=>e.children??T),i(a),i(t),f(()=>C(l,e.title)),r(d,t),P()}var H=c(`<ul class="space-y-4"><li>gRPC Gateway is a versatile tool that bridges the gap between gRPC
